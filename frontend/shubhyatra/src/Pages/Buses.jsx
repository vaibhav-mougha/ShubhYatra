...
function Buses() {
  ...
  return (
    <div>
      <Box w="100%" m="auto" bg="rgb(10,34,61)">
        <HStack
          color={"Highlight"}
          width={["95%", "60%", "55%", "45%"]}
          m="auto"
          ...
          alignItems="center"
        >
          <Select placeholder="From" onChange={(e) => setStart(e.target.value)}>
          ...
          >
            ...
            <Menu>
              ...
              <MenuList w="250px" m="auto">
                ...
                <MenuItem onClick={()=>handleSort("lateDeparture")}>Late Departure</MenuItem>
            ...
            <Box cursor={"pointer"} w="80%" m="auto">
              ...
              <Grid gridTemplateColumns={"repeat(2,1fr)"} gap="10px">
                <VStack onClick={()=>handleFilter("Pmorning")} spacing={"0.5"} p="2px" border="1px solid teal">
                ...
                <VStack onClick={()=>handleFilter("Pafternoon")} spacing={"0.5"} p="2px" border="1px solid teal">
                ...
                <VStack onClick={()=>handleFilter("Pevening")} spacing={"0.5"} p="2px" border="1px solid teal">
                ...
                <VStack onClick={()=>handleFilter("Pnight")} spacing={"0.5"} p="2px" border="1px solid teal">
            ...
            <Box cursor={"pointer"} w="80%" m="auto">
              ...
              <Grid gridTemplateColumns={"repeat(2,1fr)"} gap="10px">
                <VStack onClick={()=>handleFilter("Dmorning")} spacing={"0.5"} p="2px" border="1px solid teal">
                  <BsBrightnessAltHigh fontSize={"26px"} />
                  <Heading size="xs">Morning</Heading>
                  <Text fontSize="xs" color={"teal"}>
                    6AM to 11AM
                ...
                <VStack onClick={()=>handleFilter("Dafternoon")} spacing={"0.5"} p="2px" border="1px solid teal">
                  <BsBrightnessHigh fontSize={"26px"} />
                  <Heading size="xs">afternoon</Heading>
                  <Text fontSize="xs" color={"teal"}>
                    11AM to 6PM
                ...
                <VStack onClick={()=>handleFilter("Devening")} spacing={"0.5"} p="2px" border="1px solid teal">
                  <BsFillCloudSunFill fontSize={"26px"} />
                  <Heading size="xs">evening</Heading>
                  <Text fontSize="xs" color={"teal"}>
                    6PM to 11PM
                ...
                <VStack onClick={()=>handleFilter("Dnight")} spacing={"0.5"} p="2px" border="1px solid teal">
                  <BsFillCloudMoonFill fontSize={"26px"} />
                  <Heading size="xs">night</Heading>
                  <Text fontSize="xs" color={"teal"}>
                  11PM to 6AM

          ...
          <Box className="sec">
            <Box className="res_name">
              ...
              <Box className="rating">
                ...
                <Box mr="0.5rem"></Box>
                <h4>
                  <span style={{ color: "rgb(54, 54, 217)" }}>
                    {data.verified_rating}
                  </span>
                  (124 VERIFIED RATING)
                </h4>
              </Box>
      ...
      <Flex w="100%" p="5" ml="0" mt="4" bg="rgb(255,237,209)">
        <Box borderRight="1px solid black" p={2}>
          ...
          <OrderedList>
            ...
            <ListItem>PAN Card is not accepted as ID proof(s)</ListItem>
            <ListItem>
              Passport, Aadhar and Driving License are accepted as ID proof(s)
            </ListItem>
            <ListItem>Property staff is trained on hygiene guidelines</ListItem>
            <ListItem>Pets are not allowed.</ListItem>
          </OrderedList>
        </Box>
        ...
        <Box borderRight="1px solid black" p={2}>
          ...
          <OrderedList>
            ...
            <ListItem>Guests from containment zones are allowed</ListItem>
            <ListItem>
              Passport, Aadhar and Driving License are accepted as ID proof(s)
            </ListItem>
            <ListItem>
        ...
        <Box p={2}>
          ...
          <OrderedList>
            ...
            <ListItem>Guests below 18 years of age are allowed</ListItem>
            <ListItem>Bachelors allowed</ListItem>
            <ListItem>Suitable for children</ListItem>
            <ListItem>Property staff is trained on hygiene guidelines</ListItem>
          </OrderedList>
        </Box>
      </Flex>

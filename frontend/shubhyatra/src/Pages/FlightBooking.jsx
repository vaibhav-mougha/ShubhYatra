...
import AllFlights from "../Components/FlightBooking/AllFlights";
  ...
  function Buses() {
    ...
    function handleSort(sort) {
      axios
        .get(`http://localhost:8080/bookedflight/?from=${start}&to=${end}&sort=${sort}`, {
          headers: {
            authorization: localStorage.getItem("token"),
          },
        })
        ...
        >
          <div w="95%" p="3" m="auto">
            <Grid
              ...
              gap={["0", "2", "3", "5", "7"]}
            >
              <Heading m="auto" size={["sm", "sm", "sm", "md", "md"]} color="#0E26AC">
              ...
              <Box cursor={"pointer"} m="auto">
                ...
                <Grid gridTemplateColumns={"repeat(2,1fr)"} gap="10px">
                  ...
                  >
                    ...
                    <Heading size="xs" color="orange">Morning</Heading>
                    <Text fontSize="xs" >
                      6AM to 11AM
                    </Text>
                  </VStack>
                  ...
                  >
                    ...
                    <Heading size="xs" color="#01A0C7">Afternoon</Heading>
                    <Text fontSize="xs" >
                      11AM to 6PM
                    </Text>
                  </VStack>
                  ...
                  >
                    ...
                    <Heading size="xs" color="#DC6778">Evening</Heading>
                    <Text fontSize="xs">
                      6PM to 11PM
                    </Text>
                  </VStack>
